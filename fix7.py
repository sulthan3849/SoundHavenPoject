...
old_button_1 = """                             <button
                               ...
                               className={`p-2 rounded-full transition-all hidden md:block ${queue.some(t => t.id === track.id.toString()) ? 'text-green-500' : 'opacity-0 group-hover:opacity-100 hover:text-white hover:bg-white/10'}`}
                               title="Download FLAC"
                             >
...
if old_button_1 in content:
    ...
    print("Failed to replace button 1")
